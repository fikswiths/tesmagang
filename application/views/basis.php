...
<html lang="en">
    ...
    <body>
        <div id="wrapper">
            <!-- <div class="left side-menu">
                <div class="slimscroll-menu" id="remove-scroll">
                    <div class="topbar-left">
                        <a href="<?= base_url('Sistem/'); ?>" class="logo">
                            <span><img src="<?= base_url('assets/images/logo_header.png'); ?>" alt="" height="60"></span>
                            <i><img src="<?= base_url('assets/images/logo_sm.png'); ?>" alt="" height="28"></i>
                        </a>
                    </div>
                    ...
                    <div id="sidebar-menu" style="margin-top: 100px;">
                        <ul class="metismenu" id="side-menu">
                            <li>
                                <a href="<?= base_url('Sistem/'); ?>">
                                    <i class="fi-air-play"></i> <span> Data Buku </span>
                                </a>
                            </li>
                            <li>
                                <a href="<?= base_url('Sistem/detail'); ?>">
                                    <i class="fi-air-play"></i> <span> Detail Buku </span>
                                </a>
                            </li>
                            <li>
                                <a href="<?= base_url('Sistem/email'); ?>">
                                    <i class="fi-air-play"></i> <span> Email </span>
                                </a>
                            </li>
                            <li>
                                <a href="<?= base_url('Sistem/paginasi'); ?>">
                                    <i class="fi-air-play"></i> <span> Pagination </span>
                                </a>
                            </li>
                        </ul>
                    </div>
                            ...
                            <li class="dropdown notification-list">
                                <a class="nav-link dropdown-toggle waves-effect nav-user" data-toggle="dropdown" href="#" role="button"
                                   aria-haspopup="false" aria-expanded="false">
                                    <img src="<?= base_url('assets/images/users/avatar-1.jpg'); ?>" alt="user" class="rounded-circle"> <span class="ml-1 pro-user-name" style="color: white;">Akun <i class="mdi mdi-chevron-down"></i> </span>
                                </a>
                        ...
                        <ul class="list-inline menu-left mb-0">
                            ...
                            <li>
                                <div class="page-title-box">
                                    <h4 class="page-title" style="font-size: 30px; color: white;">Selamat Datang <?= $nm; ?> </h4>
                                    <ol class="breadcrumb">
                                        <li class="breadcrumb-item active" style="font-size: 15px; color: white;">Username Anda: <?= $usrnm; ?></li>
                                    </ol>
                                </div>
                            </li>
            ...
            <footer class="footer" style="background-color: aqua; margin-left:-240px;">
            <div class="container">
                <div class="row">
                    <div class="col-12 text-center" style="font-size: 15px; color: black;">
                        2023 © Tes Magang - Fikri
                    </div>
                </div>
            </div>
        </footer>
