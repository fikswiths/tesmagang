                ...
                <div class="card-box ribbon-box">
                    ...
                    <div class="form-row m-b-0" style="margin-top: 45px;">
                        <div class="form-group col-md-12">
                            ...
                            <input type="text" class="form-control khusus_angka" id="txtid" placeholder="otomatis" readonly>
                        </div>
                        ...
                        <div class="form-group col-md-12 jedaobjek">
                            ...
                            <input type="text" class="form-control khusus_abjad2" id="txtnama" placeholder="ex : anto">
                        </div>
                        <div class="form-group col-md-6 jedaobjek">
                            <label class="col-form-label">Tempat Lahir</label>
                            <input type="text" class="form-control khusus_abjad2" id="txttpt" placeholder="ex : Nganjuk">
                        </div>
                        <div class="form-group col-md-6 jedaobjek">
